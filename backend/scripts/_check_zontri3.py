"""Check server main.js article detail logic"""
import paramiko, sys
...
# Get the loadArticleDetail function from server main.js
print(run("sed -n '/function loadArticleDetail/,/^}/p' /www/wwwroot/zontri.top/js/main.js"))
