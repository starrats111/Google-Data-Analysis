...
print(f"✅ PM 账号: {pm_account.account_name}, Token 前10位: {pm_account.api_token[:10] if pm_account.api_token else 'N/A'}...")
...
try:
    service = PartnerMaticService(pm_account.api_token)
