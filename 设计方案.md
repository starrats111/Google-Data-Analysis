...
> **设计人员：** AI设计师  
> **验收人员：** 07  
> **审核状态：** ✅ OPT-001~005 终审通过 ｜ ✅ OPT-006 已上线待复核 ｜ ⏳ 第九轮整改完成待复核  
> **编写日期：** 2026-02-27  
> **当前迭代：** 1.6  
> **涉及系统：** 谷歌广告数据分析平台
...
本次优化主线共 6 项功能（OPT-001 ~ OPT-006），并补充 1 项一致性契约（OPT-007）：
...
| 证据项 | 产出方式 | 对应章节 | 验收责任人 |
|--------|----------|----------|------------|
| 发现成功率日报（按平台） | `merchant_discovery_runs` 导出 | 15.5 / 16.8 | 研发 + 验收07 |
| MID缺失率告警记录 | 通知表 + 任务日志 | 15.5 / 16.5 | 研发 |
| 补偿时效达标证明 | repair_queue 时差统计 | 15.5 / 18.3 | 研发 + 审核 |
| 字段契约一致性证明 | 平台字段映射表抽检（8平台） | 15.3 | 研发 |
| 回退场景演练记录 | CG 回退流程演练日志 | 15.4 / 16.5.2 | 研发 + 审核 |
