...
WEEKLY_CRON="0 6 * * 1 curl -s -H 'Authorization: Bearer ${CRON_SECRET}' '${APP_URL}/api/cron/weekly-merchant-check' >> /var/log/cron-weekly-merchant.log 2>&1"
...
echo "  $DAILY_CRON"
echo ""
echo "Weekly merchant check (06:00 every Monday):"
echo "  $WEEKLY_CRON"
echo ""
