...
import { SemRushClient, parseDomainFromSemrushUrl, type SemRushKeyword } from "@/lib/semrush-client";
...
Example output: ["women's designer dresses", "buy formal dress online", "evening gowns sale"]`,
    ...
    console.warn(
      "[SemRush URL AI Keywords] AI 生成失败:",
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { url, country = "US", merchant_name = "" } = await req.json();
